This file contains the code that we used to create the device which could encode eye blinks into morse pattens and then convert them into understandable english by using suitable logic.
